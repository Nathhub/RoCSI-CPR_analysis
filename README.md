...
This repository contains the full bioinformatics workflow and analysis for the **RoCSI-CPR eDNA project**, part of the EU-funded AtlantECO project (https://www.atlanteco.eu/).  
