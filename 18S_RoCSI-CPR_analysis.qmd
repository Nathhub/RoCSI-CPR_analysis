...
plot_richness(ps_18s, x = "lon", measures = c("Simpson", "Observed"), color = "Water_masses", 
              title = "RoCSI (18S, MZGdb)")
```
::: {.callout-note}
### 💬 Discussion — Alpha diversity patterns

Both richness (Observed ASVs) and Simpson diversity differ between water masses, although the contrasts are not very large.
